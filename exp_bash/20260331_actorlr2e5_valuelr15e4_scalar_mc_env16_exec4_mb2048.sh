...
# Background:
# - Value-first learning remains important, but actor-side learning may still be too weak.
# Goal:
# - Increase both actor and value learning rates while keeping value learning stronger than actor learning.
# Changes vs baseline:
# - Increase actor learning rate from 1e-5 to 2e-5.
# - Increase value learning rate from 1e-4 to 1.5e-4.
...
CONFIG_NAME="20260331_actorlr2e5_valuelr15e4_scalar_mc_env16_exec4_mb2048"
